...
| Windows installer | Historical `scripts/install.ps1` (removed). | Removed from the current surface; completed by [1058](1058-depowershell-release-smoke.md). |
| PowerShell release and self-bootstrap smoke | Historical `scripts/release-smoke.ps1` / `self-bootstrap-smoke.ps1` (removed). Current: [`scripts/release-smoke.sh`](../../scripts/release-smoke.sh), [`scripts/self-bootstrap-smoke.sh`](../../scripts/self-bootstrap-smoke.sh), and [`internal/releasesmoke`](../../internal/releasesmoke). | Replaced by Go `releasesmoke` + bash drivers in Slice E / [1058](1058-depowershell-release-smoke.md). |
