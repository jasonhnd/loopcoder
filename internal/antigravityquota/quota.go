...
const (
	SchemaWindow   = "loopcoder.antigravity.quota.window.v1"
	SchemaSnapshot = "loopcoder.antigravity.quota.snapshot.v1"
...
var (
	ErrMalformed   = errors.New("antigravityquota: malformed")
	ErrUnavailable = errors.New("antigravityquota: unavailable")
	ErrTooLarge    = errors.New("antigravityquota: fixture too large")
)
