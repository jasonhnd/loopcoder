...
func DeliveryTemplate(opts Options) string {
	...
	b.WriteString("#     # Optional. Absent = 300; mark progress stale after this many seconds without phase or log growth.\n")
	b.WriteString("#     stale_after_seconds: 300\n")
	b.WriteString("#     # Optional. Absent = 900; classify hung after stale progress or stale sidecar with no live process.\n")
	b.WriteString("#     hung_after_seconds: 900\n")
