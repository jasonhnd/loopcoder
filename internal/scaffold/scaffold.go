...
func DeliveryTemplate(opts Options) string {
	...
	b.WriteString("# host:\n")
	b.WriteString("#   # Optional. auto detects the calling agent host; explicit values are codex, claude, claudecode, claude-code, paseo, or generic.\n")
	b.WriteString("#   profile: auto\n")
