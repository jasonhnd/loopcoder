...
const (
	SchemaWindow   = "loopcoder.gemini.quota.window.v1"
	SchemaSnapshot = "loopcoder.gemini.quota.snapshot.v1"
	AdapterID      = "gemini"
...
var (
	ErrMalformed   = errors.New("geminiquota: malformed")
	ErrUnavailable = errors.New("geminiquota: unavailable")
	ErrTooLarge    = errors.New("geminiquota: fixture too large")
)
