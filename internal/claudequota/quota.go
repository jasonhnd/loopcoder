...
const (
	SchemaWindow   = "loopcoder.claude.quota.window.v1"
	SchemaSnapshot = "loopcoder.claude.quota.snapshot.v1"
	AdapterID      = "claude"
...
var (
	ErrMalformed   = errors.New("claudequota: malformed")
	ErrUnavailable = errors.New("claudequota: unavailable")
	ErrTooLarge    = errors.New("claudequota: fixture too large")
)
