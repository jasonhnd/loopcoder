...
const (
	SchemaWindow   = "loopcoder.codex.quota.window.v1"
	SchemaSnapshot = "loopcoder.codex.quota.snapshot.v1"
	AdapterID      = "codex"
...
var (
	ErrMalformed   = errors.New("codexquota: malformed")
	ErrUnavailable = errors.New("codexquota: unavailable")
	ErrTooLarge    = errors.New("codexquota: fixture too large")
)
