...
- Self-hosting -- loopcoder planned, dispatched, reviewed, and merged most of its own development, including its v0.2.0 rewrite from PowerShell to Go, its v0.3.0 multi-provider worker layer, its v0.3.1 attestation layer, its v0.3.2 delivery guardrails, its v0.3.3 loopreview reliability hardening, and its v0.3.4 default-on pretty attestation relay.
